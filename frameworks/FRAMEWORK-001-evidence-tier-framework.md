...
id: FRAMEWORK-001
type: framework
title: "Evidence Tier Framework"
status: active
version: 1
tags: [evidence, verification, tiers, canonical]
related: [RULE-001, RULE-002, FRAMEWORK-002, FRAMEWORK-003, GLOSSARY]
owns: ["evidence tier taxonomy", "source-to-tier mapping"]
criteria: ["Tier 1 Primary", "Tier 2 Independent Confirmation", "Tier 3 Trusted Intermediary", "Tier 4 Corroborated Secondary", "Tier 5 Single-Source", "Tier 6 Unverified", "Tier 7 Verified False"]
summary: >
  The single, canonical seven-tier evidence taxonomy every other object
  references instead of restating: Primary > Independent Confirmation >
  Trusted Intermediary > Corroborated Secondary > Single-Source > Unverified
  > Verified False. Includes the source-to-tier reference table and
  resolved ambiguous cases (contested primary documents, track-record vs.
  per-claim tier).
...
> **This is the only tier list in the system.** [Visual Assets](/rules/RULE-002-visual-asset-priority.md), [Sources & Research Priority](/rules/RULE-001-source-priority-order.md), [On-Chain Verification](/frameworks/FRAMEWORK-002-onchain-verification.md), and [Decision Framework](/frameworks/FRAMEWORK-003-decision-framework.md) all reference this page instead of restating it. If you find a tier definition anywhere else, that's drift — delete it and link here instead.
...
**A primary document whose authenticity is itself disputed.** Do not classify as Tier 1 until authenticity is confirmed (see the [Primary Document Verification Protocol](/frameworks/FRAMEWORK-002-onchain-verification.md)). Classify as **"Tier 1 — Contested"** or fall back to a **mixed evidence chain**, and say explicitly what's unresolved.
...
See [Glossary](/GLOSSARY.md) for term definitions and [Decision Framework](/frameworks/FRAMEWORK-003-decision-framework.md) / [Publication Standard](/rules/RULE-003-publication-standard.md) for how this tier feeds a go/no-go call.
