...
id: FRAMEWORK-002
type: framework
title: "On-Chain Verification Framework"
status: active
version: 1
tags: [on-chain, verification, blockchain]
related: [FRAMEWORK-001, RULE-001]
owns: ["explorer-first verification order", "primary document verification protocol"]
criteria: ["wallet address", "transaction hash", "block height", "explorer record"]
summary: >
  Explorer-first verification order for blockchain claims, the distinction
  between primary verification (Tier 1) and trusted-intermediary
  verification (Tier 3), and the six-check Primary Document Verification
  Protocol before anything is classified Tier 1.
...
- **Trusted intermediary verification** — the information comes from a reputable analytics platform (Arkham, Lookonchain, Glassnode, CryptoQuant, Nansen, SoSoValue). Valuable and often reliable, but not the same as direct on-chain verification. (Tier 3 — see [Evidence Framework](/frameworks/FRAMEWORK-001-evidence-tier-framework.md))
...
If the document's authenticity itself is disputed, see the "contested primary evidence" case in [Evidence Framework](/frameworks/FRAMEWORK-001-evidence-tier-framework.md).
